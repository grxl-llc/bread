...
import { Users, Image, Video, Tag, CheckCircle, XCircle, Plus, Trash2, Shield, Star } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#15233A] pb-10">
      <div className="pt-6 px-5 pb-4 border-b border-white/5">
        <div className="flex items-center gap-3 mb-1">
          ...
          <h1 className="text-2xl font-bold text-[#F5F5F0]">Admin Dashboard</h1>
        </div>
        <p className="text-sm text-[#C4C4BA]/60 ml-11">Manage creators, ads, brands & partners</p>
      </div>

      <Tabs defaultValue="creators" className="px-4 pt-4">
